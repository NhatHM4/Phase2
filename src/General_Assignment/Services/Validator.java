...
import General_Assignment.User_exception.BirthDayException;
import General_Assignment.User_exception.EmailException;
...
//		System.out.println(email);
	...
	public static LocalDate validLocalDate(String sc) {
		...
		try {
			checkDate = LocalDate.parse(date, formatter);
			if (checkDate.getYear() < 1900 || checkDate.getYear() > 2022) {
